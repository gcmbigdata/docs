...
flowchart TD
    Cliente["Cliente"]
    DNS["DNS público<br/>engine.clinicamedicos.com"]
    Fortinet["Fortinet<br/>Reglas / Firewall"]
    Puertos["Puertos 443 / 80<br/>abiertos hacia el servidor"]
...
flowchart TD
    Cliente["Cliente"]
    Cloudflare["Cloudflare Edge<br/>WAF · DDoS · Rules"]
    Tunel["═══ Túnel saliente encriptado ═══"]
    Cloudflared["cloudflared agent<br/>Dentro del servidor"]
    Nginx["Nginx<br/>127.0.0.1:443"]
    Servicios["Servicios internos"]
    ...
    style Cloudflared fill:#f5a623,stroke:#333,color:#000
    style Tunel fill:#fff5f5,stroke:#333
```
